...
if __name__ == "__main__":
    ...
    with open("config/step1_config.json", "r") as f:
    ...
    lidar_processor.run_pipeline(
        ...
        skip_uncompress=exp_config["processor_settings"]["skip_uncompress"],
    )
        ...
        for path in lidar_processor.files_proc:
            ...
            try:
                ...
                chm, transf = compute_chm(
                    data,
                    resolution=exp_config["chm_settings"]["resolution"],
                    quantile=exp_config["chm_settings"]["quantile"],
                )
